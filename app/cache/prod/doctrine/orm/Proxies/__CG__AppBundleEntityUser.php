...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'path', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'file', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'salt', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'lastname', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'firstname', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'rawPassword');
        }
    ...
    public function setRawPassword($rawPassword)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRawPassword', array($rawPassword));

        return parent::setRawPassword($rawPassword);
    }
